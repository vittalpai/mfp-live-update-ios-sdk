 ...
 */
-(void) setDeviceDisplayName:(NSString*)displayName WithCompletionHandler:(void(^)(NSError* error))completionHandler;

/*
 * Get the Display name of this device from the MFP server
 */
-(void) getDeviceDisplayNameWithCompletionHandler:(void(^)(NSError *error, NSString *DisplayName))completionHandler;
